...
## PARALELIZACIÓN: plan
## ============================================================
n_workers <- max(1, parallel::detectCores() - 3)
...
## ============================================================
sizes <- c(20, 100, 200, 400, 600, 1000)
...
out_dir <- "Resultados_CIV_M2"

## ============================================================
## RUN ALL CASES (each produces independent files)
## ============================================================

cat('running M2 models...', '\n')
run_case_and_write("M2", sizes, out_dir,
                   m, R, alpha,
                   beta0, beta1, sigma,
                   beta2, df,
                   sd1, sd2, rho,
